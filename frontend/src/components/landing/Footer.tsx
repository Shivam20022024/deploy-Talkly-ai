        ...
        <div className="w-full relative pt-8 border-t border-gray-200/60 dark:border-white/[0.06]">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6 text-xs text-gray-400 dark:text-gray-500 font-medium">
              <a href="#" className="hover:text-theme-600 dark:hover:text-brand-primary transition-colors">Privacy Policy</a>
              <a href="#" className="hover:text-theme-600 dark:hover:text-brand-primary transition-colors">Terms of Service</a>
            </div>
          </div>
        </div>
      </div>
