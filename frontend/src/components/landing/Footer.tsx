    ...
    <footer className="relative bg-gray-50 dark:bg-bg-dark-elevated overflow-hidden pt-16 sm:pt-20 pb-8">
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 flex flex-col items-center text-center relative z-10">
        ...
        <div className="flex items-center gap-4 mb-8 md:mb-0">
          <SocialIcon href="https://instagram.com/talklyai" target="_blank" rel="noopener noreferrer">
          ...
          <SocialIcon href="https://x.com/talklyai" target="_blank" rel="noopener noreferrer">
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
            </svg>
          </SocialIcon>
          <SocialIcon href="https://linkedin.com/company/talklyai" target="_blank" rel="noopener noreferrer">
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
