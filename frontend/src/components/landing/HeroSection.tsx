...
export const HeroSection = ({ onStart }: { onStart?: () => void }) => {
  return (
    <section className="relative pt-24 sm:pt-32 md:pt-36 lg:pt-40 pb-16 sm:pb-20 md:pb-32 px-4 md:px-8 md:min-h-screen flex flex-col items-center bg-gradient-to-b from-white via-purple-50/30 to-gray-50 dark:from-[#060610] dark:via-[#080816] dark:to-[#0A0A1C]">
      ...
      <div className="absolute inset-0 w-full pointer-events-none z-10">
        <div className="absolute -bottom-16 md:-bottom-32 left-0 w-[40vw] md:w-[50vw] max-w-[800px] h-[300px] sm:h-[400px] md:h-[600px] lg:h-[800px]">
          <Image src="/left.png" alt="Left Decoration" fill className="object-contain object-left-bottom opacity-20 dark:opacity-60 md:dark:opacity-80" priority />
        </div>
        <div className="absolute -bottom-16 md:-bottom-32 right-0 w-[40vw] md:w-[50vw] max-w-[800px] h-[300px] sm:h-[400px] md:h-[600px] lg:h-[800px]">
          <Image src="/right.png" alt="Right Decoration" fill className="object-contain object-right-bottom opacity-20 dark:opacity-60 md:dark:opacity-80" priority />
        </div>
      </div>
        ...
        >
          <g>
            ...
            <g mask="url(#mask0_1_193)">
              ...
              <path d="M315.939 1020.88C336.242 574.987 108.919 154.504 -7.27905 0" stroke="#c4b5fd" strokeWidth="1.5" className="dark:hidden" />
              {/* Dark mode stroke */}
              <path d="M315.939 1020.88C336.242 574.987 108.919 154.504 -7.27905 0" stroke="#181623" strokeWidth="0.957683" className="hidden dark:block" />
          ...
          <defs>
            ...
            <linearGradient id="svgFillLeftLight" x1="154.967" y1="0" x2="154.967" y2="1020.88" gradientUnits="userSpaceOnUse">
              <stop stopColor="#faf7ff" /><stop offset="0.5" stopColor="#f3eaff" /><stop offset="1" stopColor="#ede5ff" />
            </linearGradient>
        ...
        >
          <g>
            ...
            <g mask="url(#mask0_1_169)">
              ...
              {/* Light mode stroke: soft violet */}
              <path d="M-2.17371 1018.01C-22.4766 572.114 204.846 151.631 321.044 -2.87305" stroke="#c4b5fd" strokeWidth="1.5" className="dark:hidden" />
              {/* Dark mode stroke */}
              <path d="M-2.17371 1018.01C-22.4766 572.114 204.846 151.631 321.044 -2.87305" stroke="#181623" strokeWidth="0.957683" className="hidden dark:block" />
              {/* Animated glow stroke – both modes */}
      ...
      <div className="max-w-[1200px] mx-auto text-center relative z-10 w-full flex flex-col items-center mt-0 md:-mt-36">
        ...
        >
          <div className="absolute inset-0 pointer-events-none flex items-center justify-center">
            <Image src="/hero/hero-float1.png" alt="Background decoration" fill className="object-contain opacity-40 dark:opacity-80" priority />
          </div>
          ...
          <div className="absolute bottom-10 sm:bottom-12 md:bottom-12 translate-y-1/2">
            ...
            <div className="relative flex items-center gap-3">
              <div className="w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-2xl md:rounded-3xl bg-gradient-to-tr from-[#DBB7F2] to-[#7A668A] flex items-center justify-center shadow-lg shadow-purple-500/20">
                <svg className="w-9 h-9 sm:w-11 sm:h-11 md:w-14 md:h-14 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <motion.p
          ...
          className="text-xs sm:text-sm md:text-base text-gray-500 dark:text-gray-400 max-w-lg md:max-w-2xl mx-auto mb-6 sm:mb-8 md:mb-10 leading-relaxed px-2"
        >
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-r from-[#DBB7F2] to-[#7A668A] blur-2xl opacity-10 dark:opacity-20 rounded-full" />
          <form className="relative flex flex-col sm:flex-row items-center p-1.5 rounded-2xl sm:rounded-full bg-white/80 dark:bg-[#181623]/80 border border-gray-200 dark:border-white/10 backdrop-blur-xl shadow-xl dark:shadow-2xl">
            <input
              type="email"
        ...
        >
          <div className="p-2 sm:p-3 md:p-5 rounded-xl sm:rounded-2xl md:rounded-[32px] bg-white/60 dark:bg-[#ffffff05] border border-gray-200/80 dark:border-white/10 backdrop-blur-md shadow-2xl relative z-10">
            ...
            />
            <div className="relative w-full aspect-[16/9] rounded-lg sm:rounded-xl overflow-hidden border border-gray-200 dark:border-white/10 bg-gray-100 dark:bg-[#060610] shadow-[0_0_40px_rgba(219,183,242,0.15)]">
              <Image
