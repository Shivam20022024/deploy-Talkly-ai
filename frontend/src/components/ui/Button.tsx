...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-primary-600 text-white hover:bg-primary-700 shadow-sm hover:shadow-md shadow-primary-500/10 border border-transparent focus:ring-primary-500",
