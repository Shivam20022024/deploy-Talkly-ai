...
export const TemplateCard = ({
  ...
  return (
    <div className="bg-bg-dark-surface border border-white/5 rounded-2xl p-5 flex flex-col justify-between h-full group hover:border-white/10 transition-colors">
