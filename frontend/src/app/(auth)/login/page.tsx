  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      if (email === 'admin@talkly.ai' && password === 'admin') {
        ...
        document.cookie = `talkly_token=${encodeURIComponent(JSON.stringify(userData))}; path=/; max-age=86400`;
      ...
      >
        ...
        <div className="text-center mt-8 space-y-6">
          <p className="text-[14px] text-gray-500 dark:text-gray-400 font-medium">
            ...
            <a href="#" className="text-theme-600 dark:text-brand-primary font-bold hover:underline underline-offset-2">
              Request Access
            </a>
          </p>
