...
import { Mail, Lock, ArrowRight, Building, User, ShieldCheck } from 'lucide-react';
...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center font-sans selection:bg-theme-500/30 selection:text-theme-900 overflow-hidden relative bg-gray-50 dark:bg-bg-dark-base transition-colors duration-300 px-4 py-8">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm font-medium text-center px-4">
            Register your company to access TalklyAI
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
            ...
            >
              {isLoading ? (
                ...
                <>
                  Create Account <ArrowRight size={18} strokeWidth={2.5} className="group-hover:translate-x-1 transition-transform" />
                </>
              )}
            </button>
          </form>
        ...
        <div className="text-center mt-8 space-y-6">
          <p className="text-[14px] text-gray-500 dark:text-gray-400 font-medium">
            ...
            <Link href="/login" className="text-theme-600 dark:text-brand-primary font-bold hover:underline underline-offset-2">
              Sign In
            </Link>
          </p>
